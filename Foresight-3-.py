...
"""
Foresight (compact, autonomous, resource-aware):
...
- Minimal compact GUI: suggestion banner, top habits list, frequency chart, single "Learning" toggle.
