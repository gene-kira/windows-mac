...
class AIEngine:
    """
    Autonomous AI organ:
    - Auto-selects backend in priority:
      LOCAL_HTTP -> REMOTE_OPENAI -> RULE_BASED
    - Still allows manual override via UI.
    """
    ...
    def __init__(self, logger: SecureLogger, memory: MemoryStore,
        ...
        self.auto_mode: bool = True  # full autonomous selection
...
class Cockpit(QWidget):
    def __init__(self):
        ...
        self._auto_timer.start(1500)  # auto brain tick
    ...
    def _auto_tick(self):
        """
        Autonomous loop:
        - If code changed, auto-purify
        - If risk != SAFE, auto AI-rewrite
        """
        ...
        # If risk is not SAFE, auto AI rewrite
