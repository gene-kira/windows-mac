...
- Dual-drive Critical Cache with autonomous failover
    - Primary cache: C:\HiveCache\primary
    - Secondary cache:
        - D:\HiveCache\secondary if D: exists
        - otherwise Z:\HiveCache\secondary (mapped network drive fallback)
...
class WindowsAdapter(OSAdapter):
    ...
    def get_cache_paths(self) -> Dict[str, str]:
        # Not used anymore for cache placement, but kept for compatibility
...
class CriticalCache:
    def __init__(self, primary_path: str, secondary_path: str):
        ...
        # secondary may be on D: or mapped drive; create best-effort
        try:
...
class NodeAgent:
    def __init__(self):
        ...
        # Explicit, deterministic cache placement:
        # Primary: C:\HiveCache\primary
        # Secondary: D:\HiveCache\secondary if D: exists, else Z:\HiveCache\secondary
        primary_base = r"C:\HiveCache"
        primary_path = os.path.join(primary_base, "primary")

        if os.path.exists(r"D:\\"):
            secondary_base = r"D:\HiveCache"
        else:
            secondary_base = r"Z:\HiveCache"
