...
# ============================================================
# EVENT BUS + TELEMETRY (FROM TKINTER APP, ADAPTED)
# ============================================================
...
# ============================================================
# CORE ENUMS, DATA, HELPERS (PYQT SWARM COCKPIT)
# ============================================================
...
# ============================================================
# LIVE SYSTEM FEEDBACK PANEL (FED BY EVENT BUS)
# ============================================================
...
# ============================================================
# THREAT CONE PANEL, OUTCOME PREDICTOR, ETC.
# ============================================================
...
# ============================================================
# MAIN WINDOW (PYQT + TELEMETRY FUSION)
# ============================================================
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # Wire event bus into this cockpit
        bus.callbacks.append(self._on_bus_event)

        # Start TCP bus + telemetry producers
    ...
    def _on_bus_event(self, event: dict):
        ...
        if etype == "window_focus":
            ...
            category = "browser" if "chrome" in source_name.lower() or "edge" in source_name.lower() else "system"
        elif etype == "key_press":
            category = "game" if "game" in source_name.lower() else "system"
        else:
            category = "network" if "network" in source_name.lower() else "system"
    ...
    def _refresh_all(self):
        ...
        browser_routes = {
            k: v for k, v in routes.items() if "Cloud" in k or "Browser" in k or "EXT" in k
        }
