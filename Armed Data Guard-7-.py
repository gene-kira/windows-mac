...
def gui():
    ...
    topbar = tk.Frame(root, bg="#0A0A0A"); topbar.pack(side=tk.TOP, fill=tk.X)
    tk.Button(topbar, text="Log", command=log, bg="#222", fg="#C0C0C0").pack(side=tk.LEFT, padx=5, pady=5)
    tk.Button(topbar, text="Filter", command=country, bg="#222", fg="#C0C0C0").pack(side=tk.LEFT, padx=5, pady=5)
