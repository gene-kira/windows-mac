...
try:
    ...
    print("[foresight] Tkinter not available.", e)
    sys.exit(1)
...
class NextGenPredictor:
    ...
    def predict(self, prev1: Optional[str], prev2: Optional[str], hour: int, dow: int, weekend: int,
        ...
        try:
            ...
            # Absolute safety: always return a tuple
            return None, 0.0, {}
...
class ForesightGUI:
    ...
    def _tick(self):
        try:
            ...
            # If anything ever slips through, keep UI alive and report succinctly
