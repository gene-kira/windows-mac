#!/usr/bin/env python3
# neural_core_v4_tk.py
# Phase 8 (Tkinter, predictive+adaptive+persistent):
# - Event-driven organs
...
# - JSON persistence (personas, critique depth, outcome stats, mode transitions)
...
# ============================================================
#  STATE CORE (with personas, templates, feedback, session, persistence)
# ============================================================
...
class MetaReasoningOrgan(Organ):
    ...
    def on_behavior(self, payload):
        ...
        # Do not spam disk here; OutcomeFeedbackOrgan persists when it has signal.
...
class ClarificationOrgan(Organ):
    ...
    def on_input(self, payload):
        ...
        # Don't interrupt when clearly in CODE/DEBUG with high confidence
...
class GUIOrgan(Organ):
    def __init__(self, root, bus, state):
        ...
        self.root = root
        self.root.title("NEURAL CORE V4 — Tkinter organism (predictive, adaptive, persistent)")
