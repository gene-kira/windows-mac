...
def validate(): return {l: "✓" if __import__(l) else subprocess.call([sys.executable, "-m", "pip", "install", l]) for l in ["psutil", "zmq", "PyQt6"]}
...
def telemetry():
    ...
    return {**real, "Fake": json.dumps(fake)}
