...
class DualPersonalityBot:
    ...
    def rogue_behavior(self):
        ...
        scrambled = reverse_mirror_encrypt("rogue vision rising")
        camo = camouflage("rogue vision rising","alien")
        self.cb(f"🜏 Rogue output: {scrambled} | {camo}")
...
class GUI(tk.Tk):
    def __init__(self):
        super().__init__()
        load_settings()
        self.title("Codex Purge Shell + ASI Console + Dual Personality Bot"); self.geometry("1100x800")
