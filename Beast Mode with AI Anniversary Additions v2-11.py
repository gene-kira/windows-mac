...
def load_settings():
    global backup_paths, override_ai, override_vision, override_price
...
class CockpitGUI:
    def __init__(self, root):
        ...
        # Animated overlay: a simple pulsing bar
    ...
    def animate_overlay(self):
        # Simple animation: bar width based on overall threat
...
def main():
    ...
    log("=== Organism Cockpit (Tkinter, Tiny Models, Persistent, Watchdog, Swarm, EventBus) ===")
    ensure_source_dir()
    load_settings()
