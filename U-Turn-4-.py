...
# AI mode tuning: ultra-fast reaction
...
class MemoryCore:
    ...
    def __init__(
        ...
        self.state: Dict[str, Any] = {
            ...
            "ui": {
                # GUI-related persistent preferences
                "boost_enabled": True,
            },
    ...
    def load(self):
        ...
        if chosen:
            self.state = chosen
            # restore backup path from state if present
    ...
    # UI state (for boost enabled, etc.)
...
class SystemOptimizer:
    """
    Baseline-aware, smart, OS-protective process optimizer.
    """
...
# --------------------------------------------------------------------
# Tkinter GUI + AI Mode + persistence upgrades
# --------------------------------------------------------------------
...
class StealthGUI:
    def __init__(self, root):
        ...
        # Auto-start booster if enabled in memory
    ...
    def set_backup_location(self):
        # Only allow setting backup path if none has been set before.
