...
# =========================================================
# 0. DEPENDENCIES (for RL organism)
# =========================================================
...
# =========================================================
# 15. UNIFIED MAIN ORGANISM STARTUP
# ============================================================

def main():
    print("===========================================")
    print("  UNIFIED COPILOT NODE - RL + ENGINE + UI")
    print("===========================================")

    # Start engine server (background)
    start_engine_server()

    # Build RL organism components
    ...
    # Tkinter root + GUIs
    root = tk.Tk()
    root.title("Unified Copilot Node - Core Console")

    # RL training GUI lives in the root window
    BrainGUI(root, brain, mm, stats)

    # Tinkler + Chat as Toplevels
    TinklerWindow(root)
    ChatWindow(root)
