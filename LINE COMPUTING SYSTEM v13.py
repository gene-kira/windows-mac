...
# - Extensibility hooks: settings, modules, event bus
# - Network monitoring (basic, via psutil if available)
# - Command-line entropy analysis (suspicious CLI detection)
# - File-system watchers (polling for changes in configured paths)
# - Risk history + replay simulator (re-run event streams)
# - Threat-glyph renderer (symbolic threat representation)
# ============================================================
...
def load_settings():
    ...
    return {
        ...
        # Baseline app mix – tune these for your box
        "process_whitelist": [
        ...
        # Process policies: allow | log | alert | kill | ignore
        "process_policies": {
        ...
        # Network monitor tuning
        "network_monitor": {
            "enabled": True,
            "poll_interval": 5.0,
            "bytes_threshold_per_interval": 10000000  # 10 MB
        },

        # File-system watcher
        "fs_watcher": {
            "enabled": False,
            "paths": [],  # e.g. ["C:\\Users\\you\\Downloads"]
            "poll_interval": 5.0,
...
def compute_cmd_entropy(pid):
    ...
    try:
        ...
        if ent > 4.5:  # fairly high entropy
...
class SystemEventCollector:
    def __init__(self, engine: LineComputer, policy_engine: ProcessPolicyEngine,
        ...
        self.fs_snapshots = {}  # path -> set of file hashes
