...
# BorgComm defaults (LAN comms)
DEFAULT_BORG_PORT = 45678
DEFAULT_BORG_KEY = "borg-shared-secret"  # can be overridden in config
...
# ============================================================
# BORG COMM ENGINE (LAN COMMUNICATION WITH SIMPLE ENCRYPTION)
# ============================================================

class BorgCommEngine(threading.Thread):
    """
    Simple LAN comms engine:
    - UDP unicast with symmetric XOR-style "encryption" (demo only, not real security)
    - Nodes send JSON messages (status, prediction, etc.) to each other
    """
...
# ============================================================
# QUEEN + NODES (NOW WITH BORG COMM)
# ============================================================
...
class BorgGUI:
    def __init__(self, root, queen, node_list, shared_dirs_ref, config_ref, shared_registry, cfg):
        ...
        self.root.title("BorgNet Guardian with BorgComm")
    ...
    def _build_layout(self):
        ...
        nodes_frame = ttk.LabelFrame(middle_frame, text="Collective Node States (Local + LAN)")
        ...
        self.comm_peers_label = ttk.Label(comm_frame, textvariable=self.comm_peers_var, wraplength=600)
...
def main():
    ...
    try:
        ...
        print("\n[Main] Shutting down BorgNet Guardian with BorgComm...")
