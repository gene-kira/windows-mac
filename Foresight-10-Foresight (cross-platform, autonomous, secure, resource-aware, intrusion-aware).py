...
Upgrades included:
- Multi-step (1–2 step) sequence prediction with adaptive decay
- Context features: hour, day-of-week, weekday/weekend, system load
- Cluster generalization (browser, IDE, office, terminal)
- Confidence scoring and “Why?” explainability
- Persistent predictor state in encrypted cache
- Intrusion detection: CPU/mem spikes, suspicious parents, odd hours, network deviations
- GUI hardened against tuple unpacking errors; always handles predictor output safely
"""
