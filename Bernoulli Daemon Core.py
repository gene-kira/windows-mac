...
# 🧠 Codex Bernoulli Daemon Core
class CodexBernoulliDaemon:
    ...
    def purge_node(self, node_id, payload):
        ...
        log_entry = f"Node {node_id} → Trial: {result} → Payload: {encrypted}"
...
class CodexGUI:
    def __init__(self, root):
        self.root = root
        self.root.title("Codex Bernoulli Daemon")
        ...
        self.daemon = CodexBernoulliDaemon(self.update_gui)
