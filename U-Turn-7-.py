...
# Game ecosystem protection (auto-whitelist)
...
class MemoryCore:
    ...
    - Presidential config + diagnostics
    - Guardian override
    - UI state (e.g., boost enabled)
    - Backup file path
    - Filters: whitelist/blacklist (domain-level)
    - Blocked log: recent blocked domains with reasons
    """
    ...
    def __init__(
        ...
        self.state: Dict[str, Any] = {
            ...
            "presidential": {
                ...
                "auto_trigger": True,
                "last_trigger_source": None,   # manual / forecast / cpu / game / override
                "last_trigger_reason": None,   # human readable reason
...
# --------------------------------------------------------------------
# Presidential Controller + diagnostics
# --------------------------------------------------------------------
...
class PresidentialController:
    ...
    - Uses optimizer to reduce non-essential system functions.
    - Tracks trigger source/reason and timing for diagnostics.
    - Supports mute window after override.
    """
...
class StealthGUI:
    ...
    def force_exit_presidential(self):
        if self.presidential.is_active():
            ...
            self._log("Emergency bypass: Presidential Mode forcibly disabled for 30 seconds.")
        self._update_presidential_color()
