...
class CodexReasoner:
    ...
    def get_threats(self):
        ...
        for eq in self.constraints:
            if any(term.name in ["danger", "critical", "breach"] for term in eq.free_symbols):
...
class CodexGUI(tk.Tk):
    def __init__(self, reasoner):
        super().__init__()
        self.title("Codex Reasoner Daemon")
    ...
    def _build_mutation_panel(self, parent):
        ...
        self.mutation_text = tk.Text(parent, wrap=tk.WORD, width=100, height=25, font=("Consolas", 10)); self.mutation_text.pack()
    ...
    def _build_threat_panel(self, parent):
        ...
        self.threat_text = tk.Text(parent, wrap=tk.WORD, width=100, height=25, font=("Consolas", 10), fg="red"); self.threat_text.pack()
