...
#     - Triggers only on NEW clipboard text (A3 + C2)
# - GUI visuals for health, safe mode, net status, critique cycles, mind stream, evolution log
...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def _init_ui(self):
        ...
        self.organs_list.setFixedHeight(260)
...
# ========= BRAIN LOOP (QUEUE-DRIVEN, SELF-CRITIQUE) =========
