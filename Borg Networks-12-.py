...
# ============================================================
# PREDICTIVE AI ENGINE (LOCAL ONLY, B2-INTEGRATED)
# ============================================================
...
class PredictiveAIEngine(threading.Thread):
    ...
    def _compute_anomaly_prediction(self):
        ...
        # B2: aggressive guessing overlay
        ...
        # B2 feedback: consider “correct” if there is real unusual/sequence activity
    ...
    def _compute_drive_prediction(self):
        ...
        # B2: aggressive drive risk guessing
        ...
        # B2 feedback: consider high if any drive is offline/failing or score high
        actual_high = (
...
class BorgGUI:
    ...
    def _update_hud_panel(self):
        ...
        # Derive a simple B2 “pressure” signal from anomalies
